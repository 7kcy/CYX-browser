 ...
 *
 * v7 additions:
 *  - Game site passthrough headers (Poki, io games)
 *  - Increased body size limit for game assets (64MB)
 *  - Better iframe sandbox for embedded game content
 *  - Cookie passthrough improvements for game auth
 *
 * Fixes over v5:
...
const RATE_MAX       = 500; // increased for game asset loading
